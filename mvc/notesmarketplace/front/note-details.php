...
<body>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div id="note-info">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12 col-12"><span class="inappropriate">5 People Marked as a inappropriate</span></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        function login(){
            ...
            window.location.href = "/notesmarketplace/front/login.php";
        }
    </script>
</body>
