        ...
        <div class="container">
            <section id="my-downloads">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM downloads WHERE downloader = $user_id AND issellerhasalloweddownload=1 AND seller != downloader AND isactive = 1  GROUP BY noteid ORDER BY AttachmentDownloadeddate DESC";
                                                ...
                                                <form method="post">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="Title" class="form-control" type="text" value="<?php echo $title;?>" name="title"
                                                                readonly>
